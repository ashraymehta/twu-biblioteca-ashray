...
public class ReturnBookViewTest {
    ...
    public void shouldDisplaySuccessfulMessage() throws Exception {
        ...
        String actualOutput = outputStream.toString();
        String expectedOutput = "Thank you for returning the books." + System.lineSeparator();
    ...
    public void shouldDisplayUnsuccessfulMessage() throws Exception {
        ...
        String actualOutput = outputStream.toString();
        String expectedOutput = "That is not a valid books to return." + System.lineSeparator();
    ...
    public void shouldDisplayMessage() throws Exception {
        ...
        Scanner scanner = new Scanner(byteArrayInputStream);
        ReturnBookView returnBookView = new ReturnBookView(books, scanner, printStream);
        returnBookView.printMessage("Thank you! Enjoy the books.");
